...
[SingleCellProjections.jl](https://github.com/BioJulia/SingleCellProjections.jl) is an easy to use and powerful package for analysis of Single Cell Expression data in Julia.
...
Source code: [SingleCellProjections.jl](https://github.com/BioJulia/SingleCellProjections.jl).
