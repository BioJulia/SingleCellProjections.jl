...
# Forward declarations of the public API functions. The implementations are added (as methods)
# by the wrapper files included further down, and by package extensions (load_csv/load_h5ad/umap/tsne).
